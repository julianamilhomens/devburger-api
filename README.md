...
| [Sequelize](https://sequelize.org/) | 6.x | PostgreSQL ORM |
...
| [Multer](https://github.com/expressjs/multer) | 1.x | File upload |
| [Stripe](https://stripe.com/) | 18.x | Payment processing |
| [Sucrase](https://github.com/alangpierce/sucrase) | 3.x | ES6+ transpilation |
| [Nodemon](https://nodemon.io/) | 3.x | Development hot reload |
| [Yup](https://github.com/jquense/yup) | 1.x | Data validation |
| [UUID](https://github.com/uuidjs/uuid) | 11.x | Unique ID generation |
| [CORS](https://github.com/expressjs/cors) | 2.x | Cross-origin security |
...
```
DevBurger/
├── devburger-api/              # Backend (Node.js + Express)
   ├── src/
   │   ├── app/
   │   │   ├── controllers/    # Business logic controllers
   │   │   ├── middlewares/    # JWT authentication and validations
   ...
   │   │   └── index.js        # PostgreSQL and MongoDB connection
   │   ├── app.js              # Express and middleware configuration
   │   ├── routes.js           # All API routes definition
...
git clone https://github.com/julianamilhomens/devburger-api.git
cd devburger-api
...
| 📖 Interface Docs | [Frontend README](https://github.com/julianamilhomens/devburger-interface) | Interface documentation |
